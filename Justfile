...
data_sources := env_var_or_default("JSON_INSPECTOR_DATA_SOURCES", "data_sources.json")
...
inspect-list-tables:
    JSON_INSPECTOR_DATA_SOURCES={{data_sources}} \
...
# Get example value for a field path  (usage: just inspect-get-field-value "table" "nested.path")
